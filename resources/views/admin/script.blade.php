<script src="{{ asset('home/vendor/jquery/jquery.min.js') }}"></script>
    ...
    <script src="https://kit.fontawesome.com/528e98ee1e.js" crossorigin="anonymous"></script>

    <script src="https://cdn.datatables.net/v/bs5/dt-1.13.4/b-2.3.6/r-2.4.1/sc-2.1.1/datatables.min.js"></script>