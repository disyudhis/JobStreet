        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            @if (session()->has('message'))
                <div class="alert alert-success" role="alert">
                    <button type="butotn" class="close" data-dismiss="alert" aria-hidden="true">x</button>
                    {{ session()->get('message') }}
                </div>
            @endif
            <!-- Main Content -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <button data-toggle="modal" data-target="#lowonganKerja"
                            class="d-none d-sm-inline-block rounded-lg btn-primary btn-lg shadow-sm"><i
                    ...
                    {{-- <div class="card">
                        @foreach ($status as $status)
                            <div class="gambar">{{ $status->image}}</div>
                        @endforeach
                    </div> --}}
                </div>
