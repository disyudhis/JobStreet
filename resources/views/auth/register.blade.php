{{-- <x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <x-input-label for="usertype" :value="__('Jenis')"></x-input-label>
            <select name="usertype" id="usertype">
                <option value="">(Pilih role)</option>
                <option value="0">Kandidat</option>
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-user" placeholder="First Name"
                                ...
                                <div class="form-group">
                                    <select name="usertype" id="usertype" class="form-control form-control-user" placeholder="Pilih Role" required>
                                        <option selected value="" class="form-control form-control-user">Pilih role</option>
